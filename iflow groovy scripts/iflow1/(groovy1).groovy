...
def Message processData(Message message) {
    ...
    // 2. Read identity from exchange properties (set by ParseControlParams)
    ...
    poList.each { po ->
        // globally-unique correlation key = originSystem + poNumber (plan §4.1)
        po.correlationId = (sourceSystem ?: "NA") + "-" + po.poNumber
